...
import csv
import button
from all_data import all_info, all_quiz
...
#background
pine1_img = pygame.image.load('img/background/buildingsfar.png').convert_alpha()
pine2_img = pygame.image.load('img/background/buildingsnear.png').convert_alpha()
...
class Soldier(pygame.sprite.Sprite):
	...
	def move(self, moving_left, moving_right):
		...
		return screen_scroll, level_complete, end_reached
...
class Information(pygame.sprite.Sprite):
	def __init__(self, x, y, scale, index):
		...
		self.box_image = pygame.transform.scale(self.box_image, (int(self.box_image.get_width() * scale), int( self.box_image.get_height() * scale)))
	...
	def display_info(self):
		...
		for x,line in enumerate(lines):
			draw_text(line, font1, WHITE, self.info_x , (x*40) + self.info_y)
...
while run:
	...
	if start_game == False:
		...
		if player.alive:
			...
			screen_scroll, level_complete, end_reached = player.move(moving_left, moving_right)
