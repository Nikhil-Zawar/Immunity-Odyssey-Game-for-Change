...
all_quiz = {
    ...
    "aids" :{
        "Level1" :{
            ...
            "Option1":"HIV stands for hetero-immunodeficiency virus.",
            "Option2":"HIV is called a retro virus, since it works backwards.",
            "Option3":"HIV infects red blood cells of your immune system causing your red blood cell count to drop.",
            "Option4":"HIV can spread by sharing food with an infected person.",
        },
        "Level2" :{
            "Question" :" What points from below are correct about AIDS?",
            "Option1" :"AIDS stands for auto immunodeficiency syndrome.",
            "Option2" :"AIDS is curable and can be completely prevented by treatment.",
            "Option3" :"AIDS is a virus which causes HIV infection.",
            "Option4" :"AIDS may cause unintended weight loss, mouth and genital ulcers.",
        },
        "Level3" :{
            "Question" : "What points from below are correct about symptoms of HIV/AIDS?",
            "Option1" : "Those not infected with HIV, might still get infected with AIDS.",
            "Option2" : "Initial symptoms include night sweats, swollen lymph nodes, diarrhea.",
            "Option3" : "After getting infected, the virus does not show major symptoms for a long time.",
            "Option4" : "Once infected with AIDS, you will certainly develop cancer complications.",
        },
        "Level4" :{
            "Question" : "Select the correct answers?",
            "Option1" : "Tests for HIV include taking a single pill everyday by mouth called ART.",
            "Option2" : "ART helps in curing and completely eliminating HIV.",
            "Option3" : "Testing of HIV during window period will likely result in negative result.",
            "Option4" : "Instead of HIV virus, HIV antibodies are detected in antibody tests.",
        },
        "Level5" :{
            "Question" : "What are some methods used in managing and treating HIV/AIDS?",
            "Option1" : "If you had a sexual partner with HIV in the past, you shouldn't be worried about getting HIV.",
            "Option2" : "You can have sex without condoms, as long as you take PEPs or PrEPs everyday.",
            "Option3" : "If you have never been exposed to any STI, then no need to test for any in the future.",
            "Option4" : "ARVs can prevent passing HIV from mothers to their children.",
        }
    },
    "heartattack" : {
        "Level1":{
            "Question" : "What points from below are correct about Heart attack?",
            "Option1" : "Heart Attack is due to physical injury on the heart or its arteries.",
            "Option2" : "Heart Attack is a normal condition and no special help is required.",
            "Option3" : "Heart Attack is also known as Myocardial Infarction.",
            "Option4" : "Heart Attack is also called cardiac arrest.",
        },
        "Level2":{
            "Question" : " What points from below are correct about Cardiac Arrest?",
            "Option1" : "If a person suffers sudden chest pain, then wait for emergency services to come help.",
            "Option2" : "Cardiac Arrest happens due to heavy blockage of heart arteries.",
            "Option3" : "Cardiac Arrest can only happen if you've got any heart diseases.",
            "Option4" : "Emergency treatment for cardiac arrest include giving CPR with regular resxue breaths.",
        },
        "Level3":{
            "Question" : "Which of the following is a common symptom of both a heart attack and cardiac arrest?",
            "Option1" : "Chest pain or discomfort",
            "Option2" : "Numbness or tingling in the extremities",
            "Option3" : "Sudden loss of consciousness",
            "Option4" : "Difficulty breathing or shortness of breath",
        },
        "Level4":{
            "Question" : "Which of the following statements about diagnosis and tests for heart attack is/are correct?",
            "Option1" : "A physical examination is typically conducted if heart attack symptoms are present.",
            "Option2" : "Blood tests, ECG, echocardiogram, coronary angiogram, and heart MRI are commonly performed tests for diagnosis.",
            "Option3" : "An echocardiogram utilizes magnetic waves to generate an image of the heart's chambers and valves.",
            "Option4" : "MRI testing employs a powerful sound waves to produce an image of the heart, revealing potential issues.",
        },
        "Level5":{
            "Question" : "Choose the correct option(s):",
            "Option1" : "Defibrillation can restart the person's heart if they haven't received a shock from an AED yet.",
            "Option2" : "Treating heart attack means increasing oxygen level of the body.",
            "Option3" : "Angioplasty opens the blocked artery by using a balloon or by removing the plaque buildup.",
            "Option4" : "Morphine is administered as a pain medication which helps alleviate chest pain.",
        }
    },
    "COPD":{
        "Level1" : {
            "Question" : "What points from below are correct about COPD?",
            "Option1" : "COPD stands for Chronic Obstructive Pulmonary Disease.",
            "Option2" : "Smoking and air pollution are the most common causes of COPD.",
            "Option3" : "COPD is acute disease and completely curable with proper treatment.",
            "Option4" : "COPD is an umbrella term for a range of progressive lung diseases.",
        },
        "Level2" : {
            "Question" : "What points from below are correct about Chronic Bronchitis and Emphysema?",
            "Option1" : "Chronic Bronchitis damages the walls of air sacs, making harder to breath.",
            "Option2" : "Emphysema is caused by allergens.",
            "Option3" : "Chronic Bronchitis damages small hair:like structures called cilia.",
            "Option4" : "Emphysema causes daily cough and mucus production in the bronchial tubes.",
        },
        "Level3" : {
            "Question" : "What points from below are correct about COPD?",
            "Option1" : "As COPD progresses, people find it more difficult to carry out their normal daily activities.",
            "Option2" : "Symptoms show up as soon as person gets COPD.",
            "Option3" : "A chronic cough that may produce white, green or yellowish mucus is a symptom of COPD.",
            "Option4" : "You should consult healthcare provider if unexplained weight loss, blood in mucus, sustained swelling in feets.",
        },
        "Level4" : {
            "Question" : "Select the correct answers?",
            "Option1" : "X-ray can show Emphysema and rule out other lung problems or heart failure.",
            "Option2" : "CT scans can detect Emphysema and screen lung cancer.",
            "Option3" : "Lab tests are used to diagnose COPD to determine the cause of your symptoms.",
            "Option4" : "With stage 2 or higher COPD, you also become prone to lung infections like bronchitis and pneunomia.",
        },
        "Level5" : {
            "Question" : "Select the correct answers?",
            "Option1" : "Inhalers are used for reducing or preventing some symptoms.",
            "Option2" : "Inhaled medicines that open and reduce swelling in the airways are the main treatments.",
            "Option3" : "Whatever changes incorporated in lifestyle can't improve COPD once worsen.",
    ...
    "alzheimers" : {
        "Level1" : {
            ...
            "Option2" : "Alzheimer’s disease (AD) is the most common cause of dementia.",
            "Option3" : "Dementia and Alzheimer are the same.",
            "Option4" : "Dementia limits the daily functioning of the person over time.",
        },
        "Level2" : {
            "Question" : "What points from below are correct about Dementia and Alzheimer?",
            "Option1" : "People with AD in the preclinical stage typically have no symptoms (are asymptomatic).",
            "Option2" : "Alzheimer's disease causes a decline in the ability to make sensible decisions and judgments.",
            "Option3" : "Cause of Alzheimer is failure of muscle proteins to function.",
            "Option4" : "Alzheimer causes the brain to swell and brain cells to die.",
        },
        "Level3" : {
            "Question" : " Which of the following is a key symptom of Alzheimer's disease and dementia?",
            "Option1" : "Difficulty remembering past events.",
            "Option2" : "Enhanced concentration and abstract thinking abilities.",
            "Option3" : "Improved memory retention over time.",
            "Option4" : "Persistent memory loss, especially regarding recent events or conversations.",
        },
        "Level4" : {
            "Question" : "What are some methods used in diagnosing Alzheimer's disease and dementia?",
            "Option1" : "Self-diagnosis based on internet research",
            "Option2" : "Physical and neurological exams",
            "Option3" : "Astrology readings",
            "Option4" : "An MRI is generally preferred to a CT scan to evaluate dementia.",
        },
        "Level5" : {
            "Question" : "What are some methods used in managing and treating Alzheimer's disease and dementia?",
            "Option1" : "Meditation and yoga",
            "Option2" : "Herbal remedies and supplements",
            "Option3" : "Pharmacological interventions such as cholinesterase inhibitors and NMDA antagonists",
            "Option4" : "Medicines to control blood pressure and cholesterol can prevent additional damage to the brain",
        },
    },
}
